package com.zpw.audiovideo.execise10;
...
public class Execise10Activity extends AppCompatActivity implements IPlayerCallBack {
    private static final String TAG = "Execise10Activity";
    ...
    private String initData() {
        ...
        final BufferedInputStream in = new BufferedInputStream(getResources().openRawResource(R.raw.video));
