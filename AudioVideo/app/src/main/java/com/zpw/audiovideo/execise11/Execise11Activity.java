...
import com.zpw.audiovideo.execise11.filter.GroupFilter;
import com.zpw.audiovideo.execise11.filter.WaterMarkFilter;

public class Execise11Activity extends AppCompatActivity {
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (v.resolveActivity(getPackageManager()) != null) {
                                ...
                                Toast.makeText(Execise11Activity.this, "无法找到默认媒体软件打开:" + tempPath, Toast.LENGTH_SHORT).show();
                            }
                        }
                    }, 1000);
                }
